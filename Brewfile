...
# Desktop apps in order of priority.

cask "typinator"            # (Typinator) Tool to automate the insertion of frequently used text and graphics
cask "rectangle"            # (Rectangle) Move and resize windows using keyboard shortcuts or snap areas
cask "visual-studio-code"   # (Visual Studio Code) Open-source code editor
...
cask "loopback"             # (Loopback) Cable-free audio router
...
cask "grammarly-desktop"    # (Grammarly Desktop) Grammarly for desktop
cask "vlc"                  # (VLC) Multimedia player
cask "fission"              # (Fission) Audio editor
...
# cask "freedom"            # (Freedom) App and website blocker
